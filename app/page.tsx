  ...
  return (
    <main>
      ...
      <section className="pricing" id="membership"><div className="container"><div className="pricing-top"><div><p className="eyebrow red"><i /> Come as you are</p><h2>Start your<br /><em>Femme era.</em></h2></div><p>Choose the rhythm that feels right. No contracts. Just your next move.</p></div>
        <div className="intro-offer"><div className="best-ribbon">NEW STUDENTS</div><div><p className="eyebrow">Your first step</p><h3>Femme First Timer<br />Special</h3><p className="offer-copy">Three classes. Fourteen days.<br />Explore every side of Femme.</p></div><div className="offer-price"><small>One-time</small><b>$39</b><small>Valid for 14 days</small></div><a className="button button-light" href={scheduleUrl} target="_top">Book with Wix <span>→</span></a></div>
